...
**[필수]**요구사항 분석(유스케이스 다이어그램) 	->	**[필수]**시스템 구조를 표현(컴포넌트 다이어그램)	 ->	시스템 행위의 구조화(활동 다이어그램) 	->	**[필수]** 코드 구성을 구조화(클래스 다이어그램) 	->	 각 행위의 동작(신호 송-수신 또는 반복문, 조건문, 역할)을 구조화
